<template id="login-form" align="center" >
  <div class="login-wrapper" align="center">
    <div class="login-left">
      <img height="150" src="https://i.ytimg.com/vi/6ZDECi4qJCM/maxresdefault.jpg" >
    </div>
    <form class="login-right" @submit.prevent>
      <div class="h2">Create a New Account</div>

      <div style="color:black; font-size:10px;">
        Already have an account ?
        <a href="/xyz" target="_blank" class="text-sm text-blue-500 underline hover:text-blue-700" style="font-size:10px;">
            Log in
        </a>
    </div>
    
     <div class="form-group">
        <input type="text" id="username" placeholder="Firstname" v-model="username">
        <label for="username">Username</label>    
      </div>

       <div class="form-group">
        <input type="text" id="username" placeholder="Lastname" v-model="username">
        <label for="username">Username</label>    
      </div>
      ...
      <div><button class="button23" style="top: 40px;right: 50px;">
        <a href="/product" type="button" >SIGN UP</a></button>
      </div>
    </form>
  </div>
</template>
